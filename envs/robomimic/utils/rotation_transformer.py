...
class RotationTransformer:
    ...
    def __init__(self, 
        ...
        if from_rep != 'matrix':
            funcs = [
                getattr(transforms, f'{from_rep}_to_matrix'),
                getattr(transforms, f'matrix_to_{from_rep}')
            ]
        ...
        if to_rep != 'matrix':
            funcs = [
                getattr(transforms, f'matrix_to_{to_rep}'),
                getattr(transforms, f'{to_rep}_to_matrix')
            ]
